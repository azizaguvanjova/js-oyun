...
var noise = x => {
  ...
  return lerp(pts[Math.floor(x)],pts[Math.ceil(x)],x- Math.floor(x));
    ...
    var bgcolor= "#ff7f00"; // turuncu
    var forecolor = "#4a3f35";// açik grı
    var linecolor = "#2f2519";// koyu grı
    var linewidth  = 4;
    var offset = -10;
    var yRatio = .3
    var t = 0;
    ...
    var player = new function(){
        ...
        this.truck.src = "PngItem_1496787.png";
        this.rot = 0;
        this.ySpeed = 0;
        this.rSpeed = 0;
...
//*  rotation calc
            ...
            ctx.rotate(this.rot);
            ctx.drawImage(this.truck,-38,-50,90,90);
            ctx.restore();
        }
